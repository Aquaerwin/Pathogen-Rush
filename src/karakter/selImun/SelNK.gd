...
# SIGNALS
# ==============================================================================
# Sinyal untuk melempar peluru khusus Sel NK
...
# ==============================================================================
@export var damage: int # Besar kerusakan (damage) yang dihasilkan oleh peluru Sel NK
...
func _ready():
	...
	# Total durasi jeda yang dirancang untuk Sel NK (animasi + timer)
	attack_timer.wait_time = 4.5
...
func attack():
	...
	# Tunggu sejenak hingga frame animasi pas berada pada posisi memukul / melempar (0.3 detik)
	await get_tree().create_timer(0.3).timeout
	
	# Munculkan peluru tipe "nk" jika menara belum dihancurkan oleh musuh
	if not is_dead: 
		shoot_bullet.emit(global_position + Vector2(40, 0), damage, "nk")
