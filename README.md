...
2. Download file instalasi sesuai perangkat Anda (Windows `.rar` / `.zip` atau Android `.apk`).
3. **Untuk bermain:** Tarik dan letakkan (*Drag & Drop* / Tap) kartu sel ke atas kotak pertahanan (Grid). Pastikan Anda memiliki cukup ATP/Energi. Tahan serangan musuh sampai waktu habis untuk memenangkan level!
